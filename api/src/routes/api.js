...
const CustomerMiddleware = require('../middleware/customerM');
...
router.get('/customer/validate', CustomerMiddleware.redirectAfterAuthentication, (req,res)=>{
    const customer = req.user
    res.status(200).json({customer})
})
router.get('/customer/logout/:id',customerController.Logout)
